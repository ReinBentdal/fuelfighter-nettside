        ...
        <>
            ...
            <div className={globalClasses.window} style={{backgroundColor: '#f8f8f8'}} >
                ...
                <div className={`${globalClasses.section} ${globalClasses.section_column}`} >
                    ...
                    <p className={`${classes.FAQ_a} ${globalClasses.two_thirds}`}>The short answer is yes! DNV GL Fuel Fighter is a subject you can attend and you will get 7.5 credits. To make sure your specific study accepts this subject you should talk to your supervisor.</p>
